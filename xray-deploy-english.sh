...
menu() {
    ...
    echo -e "  ${GREEN}2.${PLAIN}   Install Xray-${BLUE}VMESS+mKCP${PLAIN}(Deprecated)"
    echo -e "  ${GREEN}3.${PLAIN}   Install Xray-VMESS+TCP+TLS"
    echo -e "  ${GREEN}4.${PLAIN}   Install Xray-${BLUE}VMESS+WS+TLS${PLAIN}${RED}(Recommend, this profile supports traffic through CDN)${PLAIN}"
    echo -e "  ${GREEN}5.${PLAIN}   Install Xray-${BLUE}VLESS+mKCP${PLAIN}(Deprecated)"
    echo -e "  ${GREEN}6.${PLAIN}   Install Xray-VLESS+TCP+TLS"
    echo -e "  ${GREEN}7.${PLAIN}   Install -${BLUE}VLESS+WS+TLS${PLAIN}${RED}(This profile supports traffic through CDN)${PLAIN}"
    echo -e "  ${GREEN}8.${PLAIN}   Install -${BLUE}VLESS+TCP+XTLS${PLAIN}${RED}(Recommend)${PLAIN}"
